...
const elementHtmlResult = document.getElementById('champ');
const elementHtmlZero = document.getElementById('zero');
const elementHtmlOne = document.getElementById('one');
const elementHtmlTwo = document.getElementById('two');
const elementHtmlThree = document.getElementById('three');
const elementHtmlFour = document.getElementById('four');
const elementHtmlFive = document.getElementById('five');
const elementHtmlSix = document.getElementById('six');
...
if (elementHtmlZero) {
    elementHtmlZero.addEventListener('click', (event) => {
        written(elementHtmlZero.innerHTML);
    });
}
if (elementHtmlOne) {
    elementHtmlOne.addEventListener('click', (event) => {
        written(elementHtmlOne.innerHTML);
    });
}
if (elementHtmlTwo) {
    elementHtmlTwo.addEventListener('click', (event) => {
        written(elementHtmlTwo.innerHTML);
    });
}
if (elementHtmlThree) {
    elementHtmlThree.addEventListener('click', (event) => {
        written(elementHtmlThree.innerHTML);
    });
}
if (elementHtmlFour) {
    elementHtmlFour.addEventListener('click', (event) => {
        written(elementHtmlFour.innerHTML);
    });
}
if (elementHtmlFive) {
    elementHtmlFive.addEventListener('click', (event) => {
        written(elementHtmlFive.innerHTML);
    });
}
if (elementHtmlSix) {
    elementHtmlSix.addEventListener('click', (event) => {
        written(elementHtmlSix.innerHTML);
    });
}
if (elementHtmlSeven) {
    elementHtmlSeven.addEventListener('click', (event) => {
        written(elementHtmlSeven.innerHTML);
    });
}
if (elementHtmlEight) {
    elementHtmlEight.addEventListener('click', (event) => {
        written(elementHtmlEight.innerHTML);
    });
}
if (elementHtmlNine) {
    elementHtmlNine.addEventListener('click', (event) => {
